      ...
      <div className="mb-8 relative">
        ...
        {allImages.length > 1 && (
          <>
            <button
              onClick={prevImage}
              className="absolute cursor-pointer left-2 top-1/2 -translate-y-1/2 bg-black bg-opacity-50 text-white p-2 rounded-full hover:bg-[#ff8633]"
            >
            ...
            <button
              onClick={nextImage}
              className="absolute cursor-pointer right-2 top-1/2 -translate-y-1/2 bg-black bg-opacity-50 text-white p-2 rounded-full hover:bg-[#ff8633]"
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
